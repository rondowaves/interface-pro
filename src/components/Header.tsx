    ...
    <header className="bg-white shadow-lg">
          ...
          <div className="flex justify-between items-center py-2">
            <div className="flex items-center space-x-4">
              <div className="flex items-center">
                ...
                <span>698 597 466</span>
              </div>
              <div className="flex items-center">
                <EnvelopeIcon className="h-4 w-4 mr-1" />
                <span>interfacepro40@gmail.com</span>
              </div>
            </div>
            <div className="hidden md:block">
              <span>📍 B3-3, Espace commercial le MFOUNDI - Yaoundé</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          {/* Logo */}
          <div className="flex items-center">
            <LogoComponent className="hover:scale-105 transition-transform duration-200" />
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t">
              ...
              <Link href="/produits" className="block px-3 py-2 text-gray-700 hover:text-blue-600">
                Produits
              </Link>
