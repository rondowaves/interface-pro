            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="bg-white rounded-lg shadow p-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    <CubeIcon className="w-6 h-6 text-blue-600 mx-auto mb-1" />
                    <p className="font-medium text-gray-900 text-xs">Produits</p>
                  </button>
                  ...
                  >
                    ...
                    <p className="font-medium text-gray-900 text-xs">Stats</p>
                  </button>
                  ...
                  >
                    ...
                    <p className="font-medium text-gray-900 text-xs">Sécurité</p>
                  </button>
                  ...
                  >
                    ...
                    <p className="font-medium text-gray-900 text-xs">Site</p>
                  </a>
                </div>
              </div>
